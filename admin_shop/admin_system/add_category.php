         ...
         <div class="widget-content nopadding">
          <form action="" class="form-horizontal" method="POST">
            <div class="control-group">
              ...
              <div class="controls">
                <input name="categoryname" type="text" class="span11" placeholder="Category name" />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
              <button type="submit" name="action" value="save_new_category" class="btn btn-success">Save</button>
            </div>
          </form>
        </div>
