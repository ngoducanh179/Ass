...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Product</a>
  <ul>
          ...
          <form action="" class="form-horizontal" method="POST" enctype="multipart/form-data">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <input name="productname" type="text" class="span11" placeholder="Category name" value="<?php echo $product['productname']; ?>" />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="price" type="text" class="span11" placeholder="Category name" value="<?php echo $product['price']; ?>"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="file_image" type="file" class="span11" placeholder="By user" value="<?php echo $product['image']; ?>" />
              </div>
            </div> 
            <div class="control-group">
              <label class="control-label">By User :</label>
              <div class="controls">
                <input name="by_user" type="text" class="span11" placeholder="By user" value="<?php echo $product['by_user']; ?>"/>
              </div>
            </div>          
            <div class="form-actions">
              <button type="submit" name="action" value="update_product" class="btn btn-success">Update</button>
            </div>
          </form>
        </div>
