         ...
         <div class="widget-content nopadding">
          <form action="" class="form-horizontal" method="POST" enctype="multipart/form-data">
            <div class="control-group">
              ...
              <div class="controls">
                <input name="productname" type="text" class="span11" placeholder="Category name"/>
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="price" type="text" class="span11" placeholder="Category name" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="file_image" type="file" class="span11" placeholder="By user" />
              </div>
            </div> 
            <div class="control-group">
              <label class="control-label">By User :</label>
              <div class="controls">
                <input name="by_user" type="text" class="span11" placeholder="By user" />
              </div>
            </div>          
            <div class="form-actions">
              <button type="submit" name="action" value="save_new_product" class="btn btn-success">Save</button>
            </div>
          </form>
        </div>
